<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="font-heading text-2xl font-bold text-gray-900">AI Generator Soal</h1>
            <p class="text-gray-500">Generate soal ujian dengan bantuan AI</p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <form wire:submit="generate" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="topik" placeholder="Contoh: Sistem Pernapasan Manusia" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    ...
                    <div>
                        ...
                        <select wire:model="jenis" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="jumlah" min="5" max="30" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[500px]">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-gray-900">Hasil Soal</h3>
                    @if($result)
                ...
                @elseif($result)
                    ...
                    <div class="flex gap-3 mb-4 pb-4 border-b border-gray-200">
                        ...
                        <button onclick="navigator.clipboard.writeText(document.getElementById('soal-content').innerText); alert('Copied to clipboard!')" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors flex items-center gap-2 text-sm font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div id="soal-content" class="prose prose-sm max-w-none overflow-auto max-h-[600px] whitespace-pre-wrap">
                        {!! nl2br(e($result)) !!}
                    </div>
                @else
                    <div class="flex flex-col items-center justify-center h-[400px] text-gray-400">
                        ...
                        <p>Isi form dan klik Generate untuk membuat soal</p>
                    </div>
                @endif
            </div>
        </div>
